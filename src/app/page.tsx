...
const I18N = {
  ...
  lv: {
    ...
    founders: { kicker: "Komanda", title: "Dibinātāji", desc: "StoryPath veido neliela komanda Latvijā.", label: "Inovāciju un Izaugsmes direktors", },
    contact: {
      kicker: "Kontakti",
      title: "Pieteikt demo",
    ...
    <section className="relative overflow-hidden bg-white">
      ...
      <Container>
        <div className="grid gap-10 py-14 md:grid-cols-2 md:py-20">
          ...
          >
            <div className="relat50ive mt-1 h-100 w-full max-w-md overflow-hidden rounded-3xl">
              <img
                src="/images/hero-audio.png"
                alt="Audio guide experience"
                className="h-full w-full object-cover object-top"
              />
              <div className="pointer-events-none absolute inset-0 bg-gradient-to-l from-white/95 via-white/ to-white/5" />
            </div>
